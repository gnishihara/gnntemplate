#' A Custom Beamer Theme in R Markdown for the statistics course.
#'
...
#' rmarkdown::draft("slide_deck.Rmd", template = "gnn_statistics", package = "gnntemplate")
#'
#' # Compile the document
#' rmarkdown::render("slide_deck.Rmd")
#' }
gnn_statistics <- function(toc = FALSE,
                         slide_level = 2,
                         incremental = FALSE,
                         fig_width = 10,
                         fig_height = 7,
  ...
  template <- find_resource("gnn_statistics", "template.tex")
