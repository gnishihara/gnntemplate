#' A Custom Beamer Theme in R Markdown for the Bayesian course.
#'
...
#' rmarkdown::draft("slide_deck.Rmd", template = "gnn_tokuron", package = "gnntemplate")
#'
#' # Compile the document
#' rmarkdown::render("slide_deck.Rmd")
#' }
gnn_tokuron <- function(toc = FALSE,
                         slide_level = 2,
                         incremental = FALSE,
                         fig_width = 10,
                         fig_height = 7,
  ...
  template <- find_resource("gnn_tokuron", "template.tex")
